//Using SDL, SDL_Image, string and standard IO
#include <SDL.h>
#include <SDL_image.h>
#include <stdio.h>
#include <string>
...
bool loadMedia()
{
	...
	gKeyPressSurfaces[KEY_PRESS_SURFACE_DEFAULT] = loadSurface("Resources/Loaded.png");
	if (gKeyPressSurfaces[KEY_PRESS_SURFACE_DEFAULT] == NULL)
	{
		printf("Failed to load defalt image!\n");
		success = false;
	}
